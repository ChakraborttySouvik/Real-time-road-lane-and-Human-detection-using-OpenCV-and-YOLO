...
cap = cv2.VideoCapture(r"C:\Users\souvi\OneDrive\Desktop\New folder (2)\Data\Manhattan_Trim.mp4")
frame_width = int(cap.get(cv2.CAP_PROP_FRAME_WIDTH))
frame_height = int(cap.get(cv2.CAP_PROP_FRAME_HEIGHT))
fourcc = cv2.VideoWriter_fourcc(*"XVID")
saved_frame = cv2.VideoWriter("lane_detection.Souvik", fourcc, 30.0, (frame_width, frame_height))
